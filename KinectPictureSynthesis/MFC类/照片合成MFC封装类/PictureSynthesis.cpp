...
Mat CPictureSynthesis::NextPictureSynthesize()
{
	...
	//char strF2[100];
	//itoa((count_F + 1) % this->photoNumber, strF2, 10);
	//string strF3 = ".png";
	//string nextFrontPhotosPath = strF1 + strF2 + strF3;
	//Mat srcAlpha, nextFrontPhoto;
	//srcAlpha = imread(nextFrontPhotosPath, -1);
	//resize(srcAlpha, nextFrontPhoto, Size(colorWidth, colorHeight));

	////mapToMat(nextFrontPhoto, nextBackground, 0, 0);
	//this->cvAdd4cMat_q(nextBackground, nextFrontPhoto, 1.0);
...
Mat CPictureSynthesis::LastPictureSynthesize()
{
	...
	//string strF1 = "../Outlook/test";
	//char strF2[100];
	//itoa((count_F + this->photoNumber - 1) % this->photoNumber, strF2, 10);
	//string strF3 = ".png";
	//string lastFrontPhotosPath = strF1 + strF2 + strF3;

	//Mat srcAlpha, lastFrontPhoto;
	//srcAlpha = imread(lastFrontPhotosPath, -1);
	//resize(srcAlpha, lastFrontPhoto, Size(colorWidth, colorHeight));

	////mapToMat(lastFrontPhoto, lastBackground, 0, 0);
	//this->cvAdd4cMat_q(lastBackground, lastFrontPhoto, 1.0);
